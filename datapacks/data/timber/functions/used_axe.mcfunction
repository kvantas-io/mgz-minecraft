...
execute unless score @s timber_disabled matches 1.. if score @s timber_m_axe matches 1.. if score moonstone_axe timber matches 1.. run function timber:sneaking
...
scoreboard players set @s timber_m_axe 0